...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 301.0, 14.0, 430.0, 237.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.192383, 266.0, 62.807617, 16.0 ],
					"presentation_rect" : [ 162.192383, 266.0, 62.807617, 16.0 ],
					"text" : [ "_($old set $2)" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 198.0, 71.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 162.192383, 236.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 198.0, 133.374023, 16.0 ],
					"presentation_rect" : [ 25.0, 198.0, 133.374023, 16.0 ],
					"text" : [ "_((($1 sub $old) sqrabs) sum)" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 206.0, 83.0, 71.22168, 17.0 ],
					"persistence" : 0,
					"presentation_rect" : [ 206.0, 83.0, 71.22168, 17.0 ],
					"scope" : 0,
					"text" : "fmat 1 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 34.5, 164.5, 215.5, 164.5 ],
					"source" : [ "obj-11", 0 ]
				}
