...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.019791, 225.0, 211.0, 36.0 ],
					"text" : "sfa.hz2bark"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 21.0, 430.0, 237.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 34.0, 68.5, 36.0, 18.0 ],
					"text" : "/ 600."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 34.0, 129.5, 32.5, 18.0 ],
					"text" : "* 6."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 34.0, 99.0, 34.0, 18.0 ],
					"text" : "asinh"
				}
