...
, 			{
				"box" : 				{
					...
					"text" : "sfa.lpc2cep converts convert the LPC coefficients into frames of cepstra.\nThis object is part of the Max porting of the function rastaplp.m from Daniel P. W. Ellis \"PLP and RASTA (and MFCC, and inversion) in MATLAB\nhttp://www.ee.columbia.edu/~dpwe/resources/matlab/rastamat/\n- The input is a Nx1 ftm object column vector containing the N LPC coefficients.\n- The output is a Nx1 column vector containing the cepstra coefficients.\n- the LPC order must be set with the message \"setorder N\".\n- The current LPC order is sent to out from the outlet with the message \"getorder\".\n- The computation is in place, the output replaces the input fmat object (use ftm.copy as in the example to preserve the input data)"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "lpc to cepstra conversion FTM external"
				}
...
, 			{
				"box" : 				{
					...
					"scope" : 0,
					"serialized_objects" : [ [ "fmat", 1 ], [ 1, "size", 13, 1 ], [ 1, "set", 0, 0, 0.277417, 0.553397, 0.949892, 0.83675, 0.263592, 0.195389, 0.904713, 0.509069, 0.917551, 0.284558, 0.565675, 0.299967, 0.553546 ] ],
					"text" : "fmat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 261.5, 61.0, 18.0 ],
					"text" : "sfa.lpc2cep"
				}
